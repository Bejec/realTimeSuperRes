...
targetRes = [1280, 720-100] # resolution of screen
...
first = 1
files = glob.glob(r'C:\Projects\SuperResolution\imagesRealtime\*')
for f in files:
    os.remove(f)
...
while(True):
    ...
    if (first):
        for i in range (1,stacks):
            imageSeq[i] = imageSeq[0]
        first = 0

    for i in range (0,stacks):
        cv2.imwrite(r"C:\Projects\SuperResolution\imagesRealtime\image%04i.jpg" %i, imageSeq[i])

    # cv2.imwrite( r"C:\Projects\SuperResolution\images\t0.jpg", imageSeq[0] )
    # cv2.imwrite( r"C:\Projects\SuperResolution\images\tm1.jpg", imageSeq[10] )
    image_folder = r"C:\Projects\SuperResolution\imagesRealtime"
    ...
    cv2.imwrite( r"C:\Projects\SuperResolution\inputRealtime1.jpg", frame )
    cv2.imwrite( r"C:\Projects\SuperResolution\outputRealtime1.jpg", outImage )
